...
namespace TSP_Project
{
    public partial class Form7 : Form
    {
        ...
        {
            string MySelect = "select Sold.SaleID, Product.ProductID, Product.PrCode, Product.PrName, Product.Price, Sold.SQuantity from(Sold inner join Product ON Sold.ProductID= Product.ProductID)";
